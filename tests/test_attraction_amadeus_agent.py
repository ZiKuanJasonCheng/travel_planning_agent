...
# Outdated: attraction_agent was refactored to use LLMItineraryService directly.
# The Amadeus activity search path no longer exists in the current implementation.
#
