...
#builder.set_entry_point("parse_feedback")  # Entry point
#builder.add_edge("parse_feedback", "transport")
builder.add_edge("transport", "accommodation")
builder.add_edge("accommodation", "attraction")
builder.add_edge("attraction", "parse_feedback")
#builder.add_edge("attraction", END)

# Add conditional re-run
builder.add_conditional_edges("parse_feedback", determine_next_step, {"redo_accommodation": "accommodation", "end": END})
